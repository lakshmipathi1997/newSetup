...
public class Admin_AlertsPage extends DriverPage {
	...
	public void selectType(String type) {
		...
		getWebDriver().findElement(By.xpath("//span[text()='" + type + "']")).click();

	}

	public void enterAlertName(String name) {
		putWait(ConstantsUtil.oneMinWait);
		clickOn(Admin_AlertsLocators.alertName);
	...
	public void selectSeverity(String severity) {
		...
		putWait(ConstantsUtil.minWait);
		getWebDriver().findElement(By.xpath("//span[@class='k-list-item-text' and text()='" + severity + "']")).click();
	}
	...
	public void selectOperation(String ope) {
		...
		putWait(ConstantsUtil.minWait);
		getWebDriver().findElement(By.xpath("//span[text()='" + ope + "']")).click();
...
//		clickOn(Admin_AlertsLocators.integrationType);
		...
		putWait(ConstantsUtil.minWait);
		getWebDriver().findElement(By.xpath("//span[text()='" + integrationType + "']")).click();
