...
public class FilterDialogLocators {
	...
	public static final String conditionDropdown = "//label[text()='@override']/following-sibling::div//span[@class='k-input-value-text']";
	public static final String dropDownOption = "//span[text()='@override']";
