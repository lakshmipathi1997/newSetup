...
public abstract class DriverTestCase {
    ...
    String picurl= System.getProperty("Environment");
    String Picos= System.getProperty("TypeOS");
    ...
    public void setup() throws Exception{
        ...
        String osVal =Picos; 
        		//propertyReader.readProperty("os");
        ...
        if(!isAlive()) {
            ...
            if (WebBrowser.Firefox.toString().equalsIgnoreCase(driverType)) {
                ...
                System.setProperty("webdriver.gecko.driver", getPath() + "//drivers//geckodriver");
